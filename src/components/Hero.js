        ...
        <>
            <div className="d-lg-flex d-none justify-content-between align-items-center mt-5">
                <div>
                    ...
                    <a href='https://drive.google.com/file/d/1RiLGPNoBqiMKv9ypcC1p6XZvwRbTtESB/view' target={'_blank'} className='btn hero-button-transparent'>
                        قائمة الطعام
                    </a>
                ...
                <div className="hero-section-mobile-frame">
                    <div className="hero-section-mobile-content">
                        ...
                        <div className="hero-section-mobile-buttons">
                            ...
                            <a href='https://drive.google.com/file/d/1RiLGPNoBqiMKv9ypcC1p6XZvwRbTtESB/view' target={'_blank'} className='btn hero-btn-transparent'>
                                قائمة الطعام
                            </a>
